...
contract CryptoDevs is ERC721Enumerable, Ownable {
    ...
    /**
      ...
      * name in our case is `Crypto YC` and symbol is `YCsec`.
      * Constructor for Crypto YC takes in the baseURI to set _baseTokenURI for the collection.
      * It also initializes an instance of whitelist interface.
      */
    constructor (address whitelistContract) ERC721("Crypto YC", "YCsec") Ownable(msg.sender) {
